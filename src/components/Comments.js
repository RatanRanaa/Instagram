...
const Comments = (props) => {
    ...
    React.useEffect(()=>{
        db.collection("posts").doc(props.id).collection("comments").onSnapshot(snp => {
    ...
    <div className='comments'>
      ...
      <div className='comments__section'>
        ...
        <form onSubmit={postComment}>
            <input onChange={e=>setState(e.target.value)} value={state} type="text" className="comment__input" placeholder="Add a comments..." required/>
        </form>) :  ( "" ) }
      </div>
    </div>
  )
